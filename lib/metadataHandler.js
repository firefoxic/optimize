...
export class MetadataHandler {
	...
	/**
	 * Writes the data object to a JSON file asynchronously.
	 * @async
 ...
 * @returns {boolean} True if the arrays contain the same elements (ignoring case and order), false otherwise.
 */
